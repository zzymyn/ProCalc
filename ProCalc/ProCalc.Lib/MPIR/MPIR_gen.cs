...
namespace ProCalc.Lib.MPIR
{
    internal static partial class MPIR
    {
        ...
        internal static extern void mpz_add_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern void mpz_bin_uiui([In, Out] ref mpz_t a0, ulong a1, ulong a2);
        ...
        internal static extern ulong mpz_cdiv_q_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern ulong mpz_cdiv_qr_ui([In, Out] ref mpz_t a0, [In, Out] ref mpz_t a1, [In] ref mpz_t a2, ulong a3);
        ...
        internal static extern ulong mpz_cdiv_r_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern int _mpz_cmp_si([In] ref mpz_t a0, long a1);
        [DllImport("mpir.dll", EntryPoint = "__g_mpz_cmp_ui")]
        internal static extern int _mpz_cmp_ui([In] ref mpz_t a0, ulong a1);
        ...
        internal static extern int mpz_cmpabs_ui([In] ref mpz_t a0, ulong a1);
        ...
        internal static extern int mpz_congruent_ui_p([In] ref mpz_t a0, ulong a1, ulong a2);
        ...
        internal static extern void mpz_divexact_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern int mpz_divisible_ui_p([In] ref mpz_t a0, ulong a1);
        ...
        internal static extern void mpz_2fac_ui([In, Out] ref mpz_t a0, ulong a1);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_mfac_uiui")]
        internal static extern void mpz_mfac_uiui([In, Out] ref mpz_t a0, ulong a1, ulong a2);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_primorial_ui")]
        internal static extern void mpz_primorial_ui([In, Out] ref mpz_t a0, ulong a1);
        ...
        internal static extern ulong mpz_fdiv_q_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern ulong mpz_fdiv_qr_ui([In, Out] ref mpz_t a0, [In, Out] ref mpz_t a1, [In] ref mpz_t a2, ulong a3);
        ...
        internal static extern ulong mpz_fdiv_r_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_fdiv_ui")]
        internal static extern ulong mpz_fdiv_ui([In] ref mpz_t a0, ulong a1);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_fib_ui")]
        internal static extern void mpz_fib_ui([In, Out] ref mpz_t a0, ulong a1);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_fib2_ui")]
        internal static extern void mpz_fib2_ui([In, Out] ref mpz_t a0, [In, Out] ref mpz_t a1, ulong a2);
        ...
        internal static extern int mpz_fits_si_p([In] ref mpz_t a0);
        ...
        internal static extern int mpz_fits_ui_p([In] ref mpz_t a0);
        ...
        internal static extern ulong mpz_gcd_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern int mpz_kronecker_si([In] ref mpz_t a0, long a1);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_kronecker_ui")]
        internal static extern int mpz_kronecker_ui([In] ref mpz_t a0, ulong a1);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_si_kronecker")]
        internal static extern int mpz_si_kronecker(long a0, [In] ref mpz_t a1);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_ui_kronecker")]
        internal static extern int mpz_ui_kronecker(ulong a0, [In] ref mpz_t a1);
        ...
        internal static extern void mpz_lcm_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_lucnum_ui")]
        internal static extern void mpz_lucnum_ui([In, Out] ref mpz_t a0, ulong a1);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_lucnum2_ui")]
        internal static extern void mpz_lucnum2_ui([In, Out] ref mpz_t a0, [In, Out] ref mpz_t a1, ulong a2);
        ...
        internal static extern void mpz_mul_si([In, Out] ref mpz_t a0, [In] ref mpz_t a1, long a2);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_mul_ui")]
        internal static extern void mpz_mul_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern void mpz_powm_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2, [In] ref mpz_t a3);
        ...
        internal static extern void mpz_nthroot([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern void mpz_sub_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        [DllImport("mpir.dll", EntryPoint = "__gmpz_ui_sub")]
        internal static extern void mpz_ui_sub([In, Out] ref mpz_t a0, ulong a1, [In] ref mpz_t a2);
        ...
        internal static extern void mpz_submul_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern ulong mpz_tdiv_ui([In] ref mpz_t a0, ulong a1);
        ...
        internal static extern ulong mpz_tdiv_q_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern ulong mpz_tdiv_qr_ui([In, Out] ref mpz_t a0, [In, Out] ref mpz_t a1, [In] ref mpz_t a2, ulong a3);
        ...
        internal static extern ulong mpz_tdiv_r_ui([In, Out] ref mpz_t a0, [In] ref mpz_t a1, ulong a2);
        ...
        internal static extern void mpz_ui_pow_ui([In, Out] ref mpz_t a0, ulong a1, ulong a2);
        ...
        internal static extern int _mpq_cmp_si([In] ref mpq_t a0, long a1, ulong a2);
        [DllImport("mpir.dll", EntryPoint = "__g_mpq_cmp_ui")]
        internal static extern int _mpq_cmp_ui([In] ref mpq_t a0, ulong a1, ulong a2);
        ...
        internal static extern void mpf_add_ui([In, Out] ref mpf_t a0, [In] ref mpf_t a1, ulong a2);
        ...
        internal static extern int mpf_cmp_si([In] ref mpf_t a0, long a1);
        [DllImport("mpir.dll", EntryPoint = "__gmpf_cmp_ui")]
        internal static extern int mpf_cmp_ui([In] ref mpf_t a0, ulong a1);
        ...
        internal static extern void mpf_div_ui([In, Out] ref mpf_t a0, [In] ref mpf_t a1, ulong a2);
        ...
        internal static extern int mpf_fits_si_p([In] ref mpf_t a0);
        ...
        internal static extern int mpf_fits_ui_p([In] ref mpf_t a0);
        ...
        internal static extern void mpf_mul_ui([In, Out] ref mpf_t a0, [In] ref mpf_t a1, ulong a2);
        ...
        internal static extern void mpf_sqrt_ui([In, Out] ref mpf_t a0, ulong a1);
        ...
        internal static extern void mpf_sub_ui([In, Out] ref mpf_t a0, [In] ref mpf_t a1, ulong a2);
        ...
        internal static extern void mpf_ui_div([In, Out] ref mpf_t a0, ulong a1, [In] ref mpf_t a2);
        [DllImport("mpir.dll", EntryPoint = "__gmpf_ui_sub")]
        internal static extern void mpf_ui_sub([In, Out] ref mpf_t a0, ulong a1, [In] ref mpf_t a2);
